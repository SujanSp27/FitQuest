  ...
  >
    ...
    >
      ...
      <Stack direction="row" gap={1} sx={{ flexWrap: 'wrap', justifyContent: 'center' }}>
        <SocialIcon label="Instagram" href="https://instagram.com/sujan_poojary_27" path="M7 2C4.2 2 2 4.2 2 7v10c0 2.8 2.2 5 5 5h10c2.8 0 5-2.2 5-5V7c0-2.8-2.2-5-5-5H7zm10 2c1.7 0 3 1.3 3 3v10c0 1.7-1.3 3-3 3H7c-1.7 0-3-1.3-3-3V7c0-1.7 1.3-3 3-3h10zm-5 3.5A5.5 5.5 0 1 0 17.5 13 5.5 5.5 0 0 0 12 7.5zm0 2A3.5 3.5 0 1 1 8.5 13 3.5 3.5 0 0 1 12 9.5zm4.25-3.25a1 1 0 1 0 1 1 1 1 0 0 0-1-1z" />
        <SocialIcon label="GitHub" href="https://github.com/SujanSp27" path="M12 .5a11.5 11.5 0 0 0-3.64 22.41c.58.11.8-.25.8-.56 0-.28-.01-1.02-.02-2-3.26.71-3.95-1.57-3.95-1.57-.52-1.32-1.28-1.67-1.28-1.67-1.05-.72.08-.71.08-.71 1.16.08 1.77 1.19 1.77 1.19 1.03 1.76 2.7 1.25 3.36.95.11-.75.4-1.25.73-1.54-2.6-.3-5.33-1.3-5.33-5.8 0-1.28.46-2.33 1.2-3.15-.12-.3-.52-1.52.11-3.17 0 0 .98-.31 3.2 1.2a11.1 11.1 0 0 1 5.83 0c2.22-1.51 3.2-1.2 3.2-1.2.63 1.65.23 2.87.11 3.17.75.82 1.2 1.87 1.2 3.15 0 4.51-2.74 5.5-5.35 5.79.41.35.77 1.03.77 2.08 0 1.5-.01 2.7-.01 3.06 0 .31.21.68.81.56A11.5 11.5 0 0 0 12 .5z" />
        <SocialIcon label="LinkedIn" href="https://www.linkedin.com/in/sujanpoojary27/" path="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.5 8h4V24h-4zM8.5 8h3.8v2.2h.06c.53-1 1.84-2.2 3.78-2.2 4.04 0 4.78 2.66 4.78 6.1V24h-4v-7.1c0-1.7-.03-3.88-2.37-3.88-2.38 0-2.75 1.86-2.75 3.77V24h-4z" />
      </Stack>
    </Stack>
    <Typography 
      variant="body2" 
